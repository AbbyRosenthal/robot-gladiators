...
var fight = function (enemyName) {
    //repeaet and execute as long as teh enemy-robot is alive
    while (playerHealth > 0 && enemyHealth > 0) {
        //ask player if they 'd like to fight or run
        var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'FIGHT' or 'SKIP' to choose.");

        //if play erpicks "skip" confirm and then stop the loop
        if (promptFight === "skip" || promptFight === "SKIP") {
            //confirtm player wants to skip
        ...
        if (promptFight === "fight" || promptFight === "FIGHT") {
            ...
            //remove player's health by subtacting the amount set in the enemyAttack variable
